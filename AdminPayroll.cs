...
namespace HRIS_JAP_ATTPAY
{
            ...
            var payrollEarnings = new Dictionary<string, decimal>
    {
        ...
        // Remove the old ParseDateRange method since we're using ParseDateRangeFromDateTime now
        private void ParseDateRange(string dateRange, out DateTime startDate, out DateTime endDate)
        {
            // This method is no longer used - keeping it for compatibility
            ParseDateRangeFromDateTime(DateTime.Now, out startDate, out endDate);
        }
    }
}