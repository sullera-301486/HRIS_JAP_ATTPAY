...
namespace HRIS_JAP_ATTPAY
{
    public partial class AdminAttendance : UserControl
    {
        ...
        {
            if (dataGridViewAttendance.Columns[e.ColumnIndex].Name == "Column7" && e.Value != null)
            {
        ...
        private void setDataGridViewAttributes()
        {
            ...
            {
                dataGridViewAttendance.Rows.Add(i + ".", "JAP-001", "Charles Macaraig", "0:00", "0:00", "N/A", "Absent", "0:00", "0:00", "Manual");
            }
        }
        ...
        {
            if (e.RowIndex >= 0 && dataGridViewAttendance.Columns[e.ColumnIndex].Name == "Column11")
