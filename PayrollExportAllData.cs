...
{
    {
        ...
        new PayrollPreset
        {
            ...
            Communication = "200",
            GrossPay = "16550",
            WithholdingTax = "986.67",
            SSS = "382.50",
            PagIbig = "200",
            Philhealth = "200",
            TotalDeductions = "5819.17",
            NetPay = "10730.83",
            SSSLoan = "0.00",
            PagIbigLoan = "208.33",
            CarLoan = "1041.67",
            ...
            SSSLoanDetails = "N/A",
            PagIbigLoanDetails = "2/48",
            CarLoanDetails = "2/72",
            HousingLoanDetails = "2/240",
            CashAdvanceDetails = "N/A",
            CoopLoanDetails = "2/24",
            CoopContributionDetails = "N/A",
            OthersDetails = "N/A",
            VacationLeaveCredit = "6",
